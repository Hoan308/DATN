...
using web.qlts.Domain.Interface;
...
namespace web.qlts.Infrastructure.Repository
{
    ...
    /// </summary>
    public class AssetRepository : BaseRepository<Domain.Entity.Asset>, IAssetRepository
    {
        ...
        public async Task<List<ReceiptAssetCommon>> GetReceiptByAssetId(List<Guid> ids)
        {
            ...
            var result = await _uow.Connection.QueryAsync<ReceiptAssetCommon>(sqlCommand, parameters, commandType: CommandType.StoredProcedure, transaction: _uow.Transaction);
        ...
        public async Task<object> GetPagging(int pageSize, int pageNumber, string? searchInput, string? M_DepartmentName, string? M_CategoryName)
        {
            ...
            //Get assetPagging
            var assetPagging = await result.ReadAsync<Domain.Entity.Asset>();

            //Get assetAll
            var assetAll = await result.ReadAsync<Domain.Entity.Asset>();
        ...
        /// </returns>
        /// Author: HMDUC (28/07/2023)
        public async Task<List<Domain.Entity.Asset>> GetAssetAllByReceipId(Guid receiptId)
        {
            ...
            var listAsset = await _uow.Connection.QueryAsync<Domain.Entity.Asset>(sqlCommand, parameters, commandType: CommandType.StoredProcedure, transaction: _uow.Transaction);
        ...
        public async Task<string> GetNewCodeAsync()
        {
            ...
            var tableName = typeof(Domain.Entity.Asset).Name;
        ...
        public async Task<Stream> GetListExport()
        {
            ...
            var listExport = await _uow.Connection.QueryAsync<Domain.Entity.Asset>(sql: sqlCommand, transaction: _uow.Transaction);
        ...
        private void BindingFormatExcel(ExcelWorksheet workSheet, IEnumerable<Domain.Entity.Asset> assets)
        {
                ...
                foreach (var col in excelColummnProperties)
                {
                    ...
                    switch (colType.Name)
                    {
                        ...
                        case "Decimal":
                            ...
                            break;
                        case "Int32":
                            value = (colValue as int?)?.ToString();
                            workSheet.Cells[rowIndex, columnIndex].Style.HorizontalAlignment = ExcelHorizontalAlignment.Right;
                            break;
                        case "Single":
        ...
        /// Author: HMDUC (29/06/2023)
        #region Field
        private readonly List<PropertyInfo> excelColummnProperties = typeof(Domain.Entity.Asset)
     .GetProperties()
