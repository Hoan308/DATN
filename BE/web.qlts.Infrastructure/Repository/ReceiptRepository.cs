...
namespace web.qlts.Infrastructure.Repository
{
    public class ReceiptRepository : BaseRepository<Receipt>, IReceiptRepository
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task<List<Domain.Entity.Asset>> GetAssetByReceiptId(Guid id)
        {
            ...
            var result = await _uow.Connection.QueryAsync<Domain.Entity.Asset>(sqlCommand, parameters, transaction: _uow.Transaction);
        ...
        public async Task<List<ReceiptAssetCommon>> GetAllReceiptByAssetId(Guid assetId, Guid receiptId)
        {
            ...
            var result = await _uow.Connection.QueryAsync<ReceiptAssetCommon>(sqlCommand, parameters, commandType: CommandType.StoredProcedure);
        ...
        public async Task<int> InsertReceiptAndAssetAsync(Receipt receipt, List<ReceiptAsset> listAsset, List<MemberReceipt> listMembers)
        {
            ...
            try
            {
                ...
                foreach (var asset in listAsset)
                {
                    ...
                    sql += $"UPDATE asset a SET a.Quantity = {asset.Quantity} WHERE a.AssetId = '{asset.AssetId}';";
        ...
        public async Task<List<Receipt>> GetReceiptAccured(List<Guid> ids, Guid receiptId)
        {
            ...
            var result = await _uow.Connection.QueryAsync<Receipt>(sqlCommand, parameters, commandType: CommandType.StoredProcedure, transaction: _uow.Transaction);
        ...
        public async Task<int> DeleteOnlyReceiptAsync(Guid id)
        {
            ...
            try
            {
                ...
                var listAssetReceipt = await GetAssetByReceiptId(id);
